...
var _getNodeColor = __webpack_require__(471);

var _getNodeColor2 = _interopRequireDefault(_getNodeColor);

var _getNeighbors = __webpack_require__(472);
...
svg.attr('width', width).attr('height', height).attr("viewBox", -width / 2 / scaleX + ' ' + -height / 2 / scaleY + ' ' + width / scaleX + ' ' + height / scaleY);
...
function run(data) {
    ...
    */
    ...
    //draw images
    imgElements = g.append("g").attr("class", "img").selectAll("image").data(nodes).enter().append("image").attr("height", 1).attr("width", 1).attr(" xlink:href", function (d) {
        return 'img/' + d['image name'] + '.jpg';
    });

    borderElements = g.append("g").attr("class", "rect").selectAll("rect").data(nodes).enter().append("rect").attr("stroke", _getNodeColor2.default).attr("stroke-width", 0.05).attr("height", 1).attr("width", 1).attr("fill", "none");
    ...
    function tickActions() {
        ...
        */
        imgElements.attr("x", function (d) {
            return d.x;
        }).attr("y", function (d) {
            return d.y;
        });

        borderElements.attr("x", function (d) {
            return d.x;
        }).attr("y", function (d) {
            return d.y;
        });
    ...
    var dragDrop = d3.drag().on('start', function (node) {
        neighbors = (0, _getNeighbors2.default)(node, links);
        console.log("in drag");
